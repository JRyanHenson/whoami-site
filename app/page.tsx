    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-8">
      <main className="max-w-2xl w-full">
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-2xl border border-gray-700/50">
          {/* Avatar placeholder */}
          <div className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 mx-auto mb-6 flex items-center justify-center text-4xl md:text-5xl font-bold text-white">
            RH
          </div>
          ...
          <p className="text-blue-400 text-center text-lg mb-6">
            Software Developer
          </p>

          {/* Bio */}
          <p className="text-gray-300 text-center leading-relaxed mb-8">
            Building things on the web. Passionate about clean code,
            cloud infrastructure, and continuous learning.
          </p>
